...
<h2> <%=user %> You  Are Succesfully Registered </h2>

<form action ="index.html">
<input type="submit" value="LOGIN" style="background-color:black;color:white;width:150px;height:40px;" >
</form>
</div>
</body>
</html>-->
...
.topHalf {
  ...
  background: -webkit-linear-gradient(45deg, black, #a0ebcf);
}
...
<h2> <%=uid %> You  Are Succesfully Registered </h2>
<form action ="index.html">
<input type="submit" value="LOGIN" style="background-color:black;color:white;width:150px;height:40px;" >
</form>
